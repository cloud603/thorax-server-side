...
var History = {
	...
	getHash: function(window) { console.warn('getHash Not implemented'); },
	getFragment: function(fragment, forcePushState) { console.warn('getFragment Not implemented'); },
	start: function() { /*console.warn('Not implemented'); */ },
	stop: function() { /* console.warn('Not implemented'); */ },
	checkUrl: function(e) { console.warn('checkUrl Not implemented'); },
	// Implemented API
	path: null,
	started: false,
	loadUrl: loadUrl,
